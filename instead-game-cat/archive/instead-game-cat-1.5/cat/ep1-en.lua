...
shopdlg = dlg {
	...
	[2] = _phr('I want to make a few purchases.', 'Ok... Let\'s see, what do you need?', 'pon(2); return goto("shop2")'),
...
function guardreact()
	...
	if inst:srch('mycar') then
		...
		return cat([[Four people with submachine guns escorted me to my car. I had to start the engine and drive away from the institute. I drove a dozen kilometers before the military jeep with the seeing-off guards disappeared from the rear-view mirror... ]], goto('inmycar'));
	end
	return cat([[Four armed people throw me out of the check-point.^^]], goto('inst'));
end
